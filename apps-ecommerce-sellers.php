...
<html lang="en">
    <head>
        ...
        <title>Coupon Code | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEcommerce">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="apps-ecommerce-sellers.html">Coupon Codes</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
		...
		<h3 class="text-primary">Generate Coupon Code</h3>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#generate').on('click', function(){
			$.get("back/get_coupon.php", function(data){
				$('#coupon').val(data);
			});
		});
	});
...
<html>
	...
	<body>
		...
		<table  class="table">
			<tr>
				<th scope="col"><strong>Coupon</strong></th>
